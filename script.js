...
// This is Timing multiplier for entire game engine.
let gameSpeed = 1;

// Colors here
const SKYBLUE =   { r: 0, g: 255, b: 236 };
const CYAN =  { r: 0, g: 255, b: 166 };
const VIOLET =   { r: 193, g: 0, b: 255 };
const YELLOW = { r: 240, g: 255, b: 0 };
const allColors = [SKYBLUE, CYAN, VIOLET, YELLOW];
...
const gravity = 0.3;
// Spark look
const sparkColor = 'rgba(255,255,255,.9)';
...
//for custom performance profiling.
const PERF_START = () => {};
const PERF_END = () => {};
const PERF_UPDATE = () => {};
...
const getTarget = (() => {
  ...
  return function getTarget() {
    ...
    // Target Parameters
    // --------------------------------
    let color = pickOne([SKYBLUE, CYAN, YELLOW]);
    let wireframe = false;
    let health = 1;
    let maxHealth = 3;
